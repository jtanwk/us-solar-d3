function makePlot2(data, response) {
    ...
    *************************/
    ...
    header.selectAll(".chartTitle")
        .data([{"label": "Solar Energy per capita generated by State, relative to the median state"}])
        .transition()
        .duration(DURATION)
    ...
    **********************/
    ...
    // craate container for annotations
    const annotation = plot.append("g")
        .attr("class", "annotationBox");

    // make annotation layer appear
    annotation
        .attr("opacity", 0)
        .transition()
        .duration(DURATION)
    ...
    annotation.append("text")
        .text("◀ less solar energy")
        .attr("class", "annotationText")
        .attr("x", xScale(0.8))
        .attr("y", yScale(data.length - 1))
        .attr("text-anchor", "end");
